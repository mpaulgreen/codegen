...
class TemplatedGeneratorTest {
    ...
    public void compilationUnit() {
        ...
        // template valid
        TemplatedGenerator generatorTemplateValid1 = TemplatedGenerator.builder()
                .withFallbackContext(SPRING)
                .build(context, templateName);

        assertThat(context.name()).isNotEqualTo(SPRING);

        assertThat(generatorTemplateValid1.compilationUnit()).isNotEmpty();
        assertThat(generatorTemplateValid1.compilationUnitOrThrow()).isNotNull();
        assertThat(generatorTemplateValid1.compilationUnitOrThrow(errorMessage)).isNotNull();
